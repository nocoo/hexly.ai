...
首版收录 66 个项目，备份 43 份原始图像；其余 23 个项目沿用已有 Emoji，并明确标注来源。所有项目都有中英文介绍、颜色依据和独立档案，Frogie 与 Pew 作为后续动物 Logo 家族的参考。

## 功能

- **项目导航** — 按分类浏览、搜索中英文名称与描述，访问已核实的站点或源码仓库。
- **Logo 画廊** — 查看原图、圆角应用图标、24 px 侧边栏与 16 px favicon 效果，切换四种画布背景。
