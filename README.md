...
目前收录 76 个项目，备份其中 61 份原始图像；其余 15 个项目沿用已有 Emoji，并明确标注来源。所有项目都有中英文介绍、颜色依据和独立档案。Snail 的收藏增强功能并入 [Zhe](https://hexly.ai/projects/zhe)，原项目退出目录；[Snail 2.0 历史品牌档案](https://hexly.ai/brands/snail/v2.0.0/review.html) 继续保留碎片蜗牛、独立方形/宽幅构图、明暗底纹、真实字体字标、透明图标和 favicon，以及上一版 SVG 与全部生成来源记录。
