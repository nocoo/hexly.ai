...
[Study 07](../artwork/logo-family/firefly/2026-09-06-07/brief.md) is a targeted edit of study 06. Preserve the foreground design and palette, replace the full night field with uniform white, and remove emitted light outside the solid artwork. Flame and abdomen highlights stay opaque within crisp contours. After confirmation of the new raw image, the night motif and warm glow will be built as independent recorded layers; the transparent master will remain free of light spill. New-image approval is still required before extraction or composition.
