...
[Study 05](../artwork/logo-family/firefly/2026-09-06-05/brief.md) follows that explicit scene direction: a substantial campfire with split logs, coals, and four small surrounding fireflies on a deep ink-green background. Selective facets emphasize the flame and wood structure while material colors and illumination remain physically plausible. This study generates the complete dark scene directly as `raw/generated.png`; the old white-background and isolated-mascot defaults do not apply. Its immediate checkpoint remains the untouched image, before any finishing or catalogue integration. Previous sea-glass background plans remain unselected in their original studies.
