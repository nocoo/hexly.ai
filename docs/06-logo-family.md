...
The reusable workflow skill is `../workflow/agents/skills/zhengli-project-logo/SKILL.md`. Frogie and Firefly are promoted identities. Pew remains an unadopted source-project candidate; the wider three-project replacement phase is not yet complete.
