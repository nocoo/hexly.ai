...
Showtime's existing Codex owns the actual Swift/macOS consumers and its icon commit. The owner has taken over further App monitoring and instructed Hexly to publish independently. The [website study](https://hexly.ai/logos/showtime) is complete and approved artwork is displayed, while `family.status: "review"` preserves the distinction from verified source adoption. [Onboarding](13-showtime-onboarding.md) records the README/profile commits, browser verification and publication scope.
