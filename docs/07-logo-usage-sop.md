...
Rio study `2026-09-20-01`, finishing `01`, establishes its first independent
identity under owner-delegated acceptance. Source commit `f4edf15` contains
the exact transparent `logo.png` plus separate square/rounded presentation
masters. Concurrent application development retains ownership of its UI
