...
- Floodplain folio / 河滩叶册: Robust wetland grass leaves in bent fans, paired sedge seed heads and one broad water-margin leaf.
- 水牛活动的河滩上，宽草叶与莎草穗层层错落，像知识档案中自然叠放的书页。
...
- [Paper PNG](https://h.no.mt/projects/bogo/textures/v1.0.0/texture-light.png) · [Night PNG](https://h.no.mt/projects/bogo/textures/v1.0.0/texture-dark.png) · [Exact paper prompt](https://h.no.mt/projects/bogo/textures/v1.0.0/texture-light-prompt.txt) · [Exact night prompt](https://h.no.mt/projects/bogo/textures/v1.0.0/texture-dark-prompt.txt)
- [Manifest and hashes](https://h.no.mt/projects/bogo/textures/v1.0.0/manifest.json) · [Usage/rights](https://h.no.mt/projects/bogo/textures/v1.0.0/guide.md) · [Full-canvas specimens](https://hexly.ai/textures/bogo/v1.0.0/review.html)
