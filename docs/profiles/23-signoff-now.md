...
- Counted impressions / 计数压痕: Firm uncoated paper with shallow letterpress ruling, small grouped five-stroke impressions and a few offset column stops.
- 硬挺记录纸上的压线、分组刻痕与错位栏位呼应机械计数器，表达持续记录而不伪造数据。
...
- [Paper PNG](https://h.no.mt/projects/signoff-now/textures/v1.0.0/texture-light.png) · [Night PNG](https://h.no.mt/projects/signoff-now/textures/v1.0.0/texture-dark.png) · [Exact paper prompt](https://h.no.mt/projects/signoff-now/textures/v1.0.0/texture-light-prompt.txt) · [Exact night prompt](https://h.no.mt/projects/signoff-now/textures/v1.0.0/texture-dark-prompt.txt)
- [Manifest and hashes](https://h.no.mt/projects/signoff-now/textures/v1.0.0/manifest.json) · [Usage/rights](https://h.no.mt/projects/signoff-now/textures/v1.0.0/guide.md) · [Full-canvas specimens](https://hexly.ai/textures/signoff-now/v1.0.0/review.html)
