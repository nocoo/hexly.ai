...
![Basalt source identity](https://h.no.mt/projects/basalt/identity/v1.0.0/basalt-160-0f4f3c18fd27.webp)
...
- [Preserved asset](https://h.no.mt/projects/basalt/identity/v1.0.0/basalt-family-2026-09-07-02-01-d093add49fd5.png)
...
- Brand version: `1.0.0`; [public archive](https://hexly.ai/projects/basalt#brand).
- [Light lockup](https://h.no.mt/brands/basalt/v1.0.0/lockup-light.png), [dark lockup](https://h.no.mt/brands/basalt/v1.0.0/lockup-dark.png), [favicon](https://h.no.mt/brands/basalt/v1.0.0/favicon.ico).
- [Complete usage and integration guide](https://h.no.mt/brands/basalt/v1.0.0/guide.md), [standalone specimens](https://hexly.ai/brands/basalt/v1.0.0/review.html), [all exports and SHA-256](https://h.no.mt/brands/basalt/v1.0.0/manifest.json).
- Source adoption: separate source-team handoff; no adoption commit is claimed.
- Official project identity and Hexly campaign interpretation are separate manifest roles. Existing artwork keeps its exact bytes, geometry and original colors. Heroes are authored wide/mobile compositions, with no new image-model calls. Hexly palettes and typography apply only to this archive and promotional materials, not product UI. Preserved imagery retains its recorded source rights; MIT covers authored support work and OFL covers the real font. See provenance.json and license.txt.


Candy-colored Forbidden City corner tower on white Hanbaiyu marble.
...
Navigation 24px preferred, 16px minimum. Wordmark ≥76px wide; lockup ≥160px. Use transparent PNG/ICO at small sizes without a tile, extra red dot, shadow or rounded mask. Fine facets soften at 16px.

导航推荐 24px，最小 16px。字标宽度至少 76px，组合至少 160px。小尺寸使用透明 PNG/ICO，不加底板、红点、阴影或圆角遮罩；16px 时细小切面会柔化。

## Refined identity

![Basalt refined preview](https://h.no.mt/logos/family/basalt/2026-09-08-01/01/icon-160.webp)
...
- [Transparent foreground](https://h.no.mt/logos/family/basalt/2026-09-08-01/01/transparent.png); SHA-256: `97144a6615113b5981454492776755d486183c219e5f1d8155f17572d21564e7`
- [Square icon](https://h.no.mt/logos/family/basalt/2026-09-08-01/01/icon.png), [rounded icon](https://h.no.mt/logos/family/basalt/2026-09-08-01/01/rounded.png), [white version](https://h.no.mt/logos/family/basalt/2026-09-08-01/01/white.png)
- [Untouched generation](https://h.no.mt/logos/family/basalt/2026-09-08-01/01/raw.png), [exact prompt](https://h.no.mt/logos/family/basalt/2026-09-08-01/01/prompt.txt), [public asset checksums](https://h.no.mt/logos/family/basalt/2026-09-08-01/01/manifest.json)
- [Previous original](https://h.no.mt/projects/basalt/identity/v1.0.0/basalt-family-2026-09-07-02-01-d093add49fd5.png), copied from [its immutable source](https://github.com/nocoo/basalt/blob/9e226aa5c1376351ec76a659b1a33a8139892b4b/logo.png)
