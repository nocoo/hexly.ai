...
- Understory pages / 林下叶页: Long heliconia-like leaves with clear parallel side veins, small understory fern tips and two curled young leaf edges.
- 长阔蕉叶、林下蕨尖与卷起的新叶边层叠如书页，给豹猫留下通透的热带林下空间。
...
- [Paper PNG](https://h.no.mt/projects/ocelot/textures/v1.0.0/texture-light.png) · [Night PNG](https://h.no.mt/projects/ocelot/textures/v1.0.0/texture-dark.png) · [Exact paper prompt](https://h.no.mt/projects/ocelot/textures/v1.0.0/texture-light-prompt.txt) · [Exact night prompt](https://h.no.mt/projects/ocelot/textures/v1.0.0/texture-dark-prompt.txt)
- [Manifest and hashes](https://h.no.mt/projects/ocelot/textures/v1.0.0/manifest.json) · [Usage/rights](https://h.no.mt/projects/ocelot/textures/v1.0.0/guide.md) · [Full-canvas specimens](https://hexly.ai/textures/ocelot/v1.0.0/review.html)
