...
- A windowsill garden / 窗边小花园: Rounded softly serrated catmint leaves, a few slender oat-grass blades and delicate branching stems.
...
- [Paper PNG](https://h.no.mt/projects/meowth/textures/v1.0.0/texture-light.png) · [Night PNG](https://h.no.mt/projects/meowth/textures/v1.0.0/texture-dark.png) · [Exact paper prompt](https://h.no.mt/projects/meowth/textures/v1.0.0/texture-light-prompt.txt) · [Exact night prompt](https://h.no.mt/projects/meowth/textures/v1.0.0/texture-dark-prompt.txt)
- [Manifest and hashes](https://h.no.mt/projects/meowth/textures/v1.0.0/manifest.json) · [Usage/rights](https://h.no.mt/projects/meowth/textures/v1.0.0/guide.md) · [Full-canvas specimens](https://hexly.ai/textures/meowth/v1.0.0/review.html)
