...
- Acacia at eye level / 枝头金合欢: Unmistakable delicate bipinnate acacia leaflets, one restrained curved seed pod and thin forked twigs.
- 纤细的金合欢复叶与弯曲豆荚落在枝头，像长颈鹿抬眼便能触及的一小片树冠。
...
- [Paper PNG](https://h.no.mt/projects/giraffe/textures/v1.0.0/texture-light.png) · [Night PNG](https://h.no.mt/projects/giraffe/textures/v1.0.0/texture-dark.png) · [Exact paper prompt](https://h.no.mt/projects/giraffe/textures/v1.0.0/texture-light-prompt.txt) · [Exact night prompt](https://h.no.mt/projects/giraffe/textures/v1.0.0/texture-dark-prompt.txt)
- [Manifest and hashes](https://h.no.mt/projects/giraffe/textures/v1.0.0/manifest.json) · [Usage/rights](https://h.no.mt/projects/giraffe/textures/v1.0.0/guide.md) · [Full-canvas specimens](https://hexly.ai/textures/giraffe/v1.0.0/review.html)
