# Faster Whisper — Acoustic felt

Densely woven acoustic felt, shallow elongated pill-shaped perforation rows and a few low-amplitude embossed horizontal wave fragments.

细织吸音毡与稀疏长孔收住声音，轻浅横向波纹呼应语音转写而不生成虚构转录内容。

## Scope

This v1.0.0 texture pack is independent of the existing Logo/brand kit. It decorates Hexly project pages and Hexly-created campaigns; it does not change the product's identity, palette, UI, release or archived status. Preserve official Logo bytes and colors: fe2151b4426e09c6d6b153580e4962f112b342bd01f5bab0b6d4ba83961ba4a6.
