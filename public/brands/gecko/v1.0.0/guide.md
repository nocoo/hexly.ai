# Gecko — Hexly campaign archive 1.0.0

A little perspective on time.
...
The official/source project identity is [official-logo.png](official-logo.png), preserved byte for byte: SHA-256 `8808c313490254f126fa050aee2af4d6d9496e20c007b15036a26d4c06e478d3`; native 2048×2048; decoded RGBA SHA-256 `b406b0ca8fdb6f42efd992039159ee19245cedff52b8f72d2216a79ca2db68c3`. [Original source](https://github.com/nocoo/gecko/blob/f259be7fe740ce260c9257e2870b57dec8d9e7b3/logo.png).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `8808c313490254f126fa050aee2af4d6d9496e20c007b15036a26d4c06e478d3`; native 2048×2048; decoded RGBA SHA-256 `b406b0ca8fdb6f42efd992039159ee19245cedff52b8f72d2216a79ca2db68c3`. It is byte-identical to the recorded project identity. Its colors and geometry are unchanged.
...
Sandstone shelves / 砂岩层台. Staggered sandstone ledges and short rising seams recall the surfaces beneath the gecko’s toes.
...
Use `https://hexly.ai/brands/gecko/v1.0.0/` as the immutable URL root. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.
