# Matrix — Hexly campaign archive 1.0.0

Information, with depth.

让信息有层次地展开。

Floating black-and-green layered circuit deck.
...
The official/source project identity is [official-logo.png](official-logo.png), preserved byte for byte: SHA-256 `f9490707d630bdaed3f8891082e46e3315fa1e2c7be89e63f6994b633de3aaf8`; native 2048×2048; decoded RGBA SHA-256 `7b7d7bab3ed75e93988b84ae0e29ee63dade603733294c1f27b45bc4bf2f998d`. [Original source](https://github.com/nocoo/matrix/blob/8e6f9add035b35505576f161d95393c0b8b31e07/logo.png).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `f9490707d630bdaed3f8891082e46e3315fa1e2c7be89e63f6994b633de3aaf8`; native 2048×2048; decoded RGBA SHA-256 `7b7d7bab3ed75e93988b84ae0e29ee63dade603733294c1f27b45bc4bf2f998d`. It is byte-identical to the recorded project identity. Its colors and geometry are unchanged.
...
Circuit routing grid / 电路走线. Small grid cells meet stepped routes and terminal vias, echoing the layers of the circuit deck.
...
Use `https://hexly.ai/brands/matrix/v1.0.0/` as the immutable URL root. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.
...
[Preserved family record](https://github.com/nocoo/hexly.ai/tree/d600805f7c2833d601bc32d6e3db0b02360eb0c6/artwork/logo-family/matrix/2026-09-07-01). Exact record paths, model/prompt/raw hashes when applicable, finishing source and source revisions are listed in provenance.json. Previous public Logo and family URLs remain valid.
