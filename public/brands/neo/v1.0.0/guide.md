# Neo — Hexly campaign archive 1.0.0

Your codes, kept close.
...
The official/source project identity is [official-logo.png](official-logo.png), preserved byte for byte: SHA-256 `2939c3edb084df9e8e0f823dc1433a87374e4432b6af9c94097c10d7dd36bb2d`; native 2048×2048; decoded RGBA SHA-256 `e033e674d024a43207e63bbfb4c8b15b6059e95f6de3337fe14f49a870f568e5`. [Original source](https://github.com/nocoo/neo/blob/0d750484792449914b07e9b3e3404a823493f8a5/logo.png).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `2939c3edb084df9e8e0f823dc1433a87374e4432b6af9c94097c10d7dd36bb2d`; native 2048×2048; decoded RGBA SHA-256 `e033e674d024a43207e63bbfb4c8b15b6059e95f6de3337fe14f49a870f568e5`. It is byte-identical to the recorded project identity. Its colors and geometry are unchanged.
...
Folded sunlight / 折叠日光. Wide, asymmetric rays enter from opposite corners, like sunlight folded across a sheet of paper.
...
Use `https://hexly.ai/brands/neo/v1.0.0/` as the immutable URL root. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.
...
[Preserved family record](https://github.com/nocoo/hexly.ai/tree/d600805f7c2833d601bc32d6e3db0b02360eb0c6/artwork/logo-family/neo/2026-09-07-03). Exact record paths, model/prompt/raw hashes when applicable, finishing source and source revisions are listed in provenance.json. Previous public Logo and family URLs remain valid.
