# Falcon — Hexly campaign archive 1.0.0

Decisions, in view.

让决策可见。

An off-center multicolored peregrine head.
...
The official/source project identity is [official-logo.png](official-logo.png), preserved byte for byte: SHA-256 `f3fedf54cd8415a607d41727c9126c4eddb282c8c1dc11abab44c2d51ab9af68`; native 2048×2048; decoded RGBA SHA-256 `1577e2f95a0267c8aba39b709eac9b38b21e1277377def7892bb53879d46e377`. [Original source](https://github.com/nocoo/falcon/blob/aa0e050e0f53b09d0cbfd088ed957cb74112e3dc/logo.png).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `f3fedf54cd8415a607d41727c9126c4eddb282c8c1dc11abab44c2d51ab9af68`; native 2048×2048; decoded RGBA SHA-256 `1577e2f95a0267c8aba39b709eac9b38b21e1277377def7892bb53879d46e377`. It is byte-identical to the recorded project identity. Its colors and geometry are unchanged.
...
Rock-ledge grasses / 崖边细草. Authored quiet habitat foliage, independent of the approved bird foreground.
...
Use `https://hexly.ai/brands/falcon/v1.0.0/` as the immutable URL root. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.
...
[Preserved family record](https://github.com/nocoo/hexly.ai/tree/61e738255a1d2f41a0e7aa638dc1283c7e8d5377/artwork/logo-family/falcon/2026-09-25-03). Exact record paths, model/prompt/raw hashes when applicable, finishing source and source revisions are listed in provenance.json. Previous public Logo and family URLs remain valid.
