# Lyre — Hexly campaign archive 1.0.0

Every word, in its own time.
...
The official/source project identity is [official-logo.png](official-logo.png), preserved byte for byte: SHA-256 `1ba1c248228610d3e88e3428359391702f638cb44f1b42045c6a16861c2e581a`; native 2048×2048; decoded RGBA SHA-256 `deaf3e9f786dac87e5ae0216a1813bc6c712ce1335e74bc62be8ee7e2cf27d73`. [Original source](https://github.com/nocoo/lyre/blob/78b3a126f27a5adc53e4eaf4097b785ac7cb609e/logo.png).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `1ba1c248228610d3e88e3428359391702f638cb44f1b42045c6a16861c2e581a`; native 2048×2048; decoded RGBA SHA-256 `deaf3e9f786dac87e5ae0216a1813bc6c712ce1335e74bc62be8ee7e2cf27d73`. It is byte-identical to the recorded project identity. Its colors and geometry are unchanged.
...
Lyrebird fan / 琴鸟扇羽. Unequal curved ribs form two off-center feather fans, leaving generous space between their open edges.
...
Use `https://hexly.ai/brands/lyre/v1.0.0/` as the immutable URL root. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.
...
[Preserved family record](https://github.com/nocoo/hexly.ai/tree/d600805f7c2833d601bc32d6e3db0b02360eb0c6/artwork/logo-family/lyre/2026-09-07-03). Exact record paths, model/prompt/raw hashes when applicable, finishing source and source revisions are listed in provenance.json. Previous public Logo and family URLs remain valid.
