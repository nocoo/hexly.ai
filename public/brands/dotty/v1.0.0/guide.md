# Dotty — Hexly campaign archive 1.0.0

Make a point of clarity.
...
The official/source project identity is [official-logo.png](official-logo.png), preserved byte for byte: SHA-256 `ac943ec8efec9c3c3436ad4a062d60b351bf536b62fd3a4753dbecb4d5bf6e4e`; native 2048×2048; decoded RGBA SHA-256 `1cb4c2e1444d41d290128e66b8996c913e65bb17023ef6c2105ef4fa9687fa93`. [Original source](https://github.com/nocoo/dotty/blob/1becb8026f44a20d9827cd5b4f100b6fb09836fe/logo.png).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `ac943ec8efec9c3c3436ad4a062d60b351bf536b62fd3a4753dbecb4d5bf6e4e`; native 2048×2048; decoded RGBA SHA-256 `1cb4c2e1444d41d290128e66b8996c913e65bb17023ef6c2105ef4fa9687fa93`. It is byte-identical to the recorded project identity. Its colors and geometry are unchanged.
...
Precision drafting grid / 精密绘图网格. Fine Cartesian subdivisions, stronger construction lines and registration crosses give the checker block a drafting ground.
...
Use `https://hexly.ai/brands/dotty/v1.0.0/` as the immutable URL root. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.
...
[Preserved family record](https://github.com/nocoo/hexly.ai/tree/d600805f7c2833d601bc32d6e3db0b02360eb0c6/artwork/logo-family/dotty/2026-09-07-01). Exact record paths, model/prompt/raw hashes when applicable, finishing source and source revisions are listed in provenance.json. Previous public Logo and family URLs remain valid.
