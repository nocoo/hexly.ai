# Raven — Hexly campaign archive 1.0.0
...
The official/source project identity is [official-logo.png](official-logo.png), preserved byte for byte: SHA-256 `9b5f6ee551ad4e2e082b6f99ce690bcd782db67fc0d90fdfcf46f6e28af28319`; native 2048×2048; decoded RGBA SHA-256 `a9943f772e250c4f7b6a9dad5a10163327a4219d7f9384f7363ee02c99f8d7c6`. [Original source](https://github.com/nocoo/raven/blob/c59fe3ad5a0aea2e849b2b9ee00be189091c9faf/logo.png).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `9b5f6ee551ad4e2e082b6f99ce690bcd782db67fc0d90fdfcf46f6e28af28319`; native 2048×2048; decoded RGBA SHA-256 `a9943f772e250c4f7b6a9dad5a10163327a4219d7f9384f7363ee02c99f8d7c6`. It is byte-identical to the recorded project identity. Its colors and geometry are unchanged.
...
Quill pennants / 羽翎旗面. Staggered pointed feathers and a separate slender quill suggest an open, asymmetric fan.
...
Use `https://hexly.ai/brands/raven/v1.0.0/` as the immutable URL root. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.
...
[Preserved family record](https://github.com/nocoo/hexly.ai/tree/d600805f7c2833d601bc32d6e3db0b02360eb0c6/artwork/logo-family/raven/2026-09-07-04). Exact record paths, model/prompt/raw hashes when applicable, finishing source and source revisions are listed in provenance.json. Previous public Logo and family URLs remain valid.
