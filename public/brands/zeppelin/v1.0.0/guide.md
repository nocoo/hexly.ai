# Zeppelin — Hexly campaign archive 1.0.0

Built for the distance.

为远航而生。

A titanium command vessel for an original next-generation spacecraft fleet.

## Scope and source identity

Hexly palettes, typography, red points and editorial geometry apply only to the hexly.ai archive and Hexly-authored promotional materials, video, Deck and social graphics. Independent product websites keep their own full palettes, themes and visual identity. Source Logo adoption is recorded at 8ae8e920dd3afc9114c6e9d917f698e54dc95157. Brand version 1.0.0 is independent of the product package version; kit assembly changes no runtime or product UI.

The official/source project identity is [official-logo.png](official-logo.png), preserved byte for byte: SHA-256 `fc2e1895bd279635e0d1e7180387adef421fe972391a91641f5e2e654520ac26`; native 2048×2048; decoded RGBA SHA-256 `b257ed5f15f796d31060f5bff14c46fcf98c2d2fcd71d4d035a5cf0e5f6ddcbf`. [Original source](https://h.no.mt/logos/family/zeppelin/2026-09-19-01/01/transparent.png).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `fc2e1895bd279635e0d1e7180387adef421fe972391a91641f5e2e654520ac26`; native 2048×2048; decoded RGBA SHA-256 `b257ed5f15f796d31060f5bff14c46fcf98c2d2fcd71d4d035a5cf0e5f6ddcbf`. It is byte-identical to the recorded project identity. Its colors and geometry are unchanged.

Any future generated campaign Hero must be separately identified as a Hexly campaign interpretation, with its actual prompt/model/raw records. It cannot silently become an official project Logo. The owner approved a new gpt-image-2.5-sunburst identity for this onboarding; its exact prompt and returned bytes are archived. Kit and Hero assembly make **zero additional** image-generation calls.
...
Navigation 24px preferred, 16px minimum. Wordmark ≥84px wide; lockup ≥160px. Use transparent PNG/ICO at small sizes without a tile, extra red dot, shadow or rounded mask. Fine material detail softens at 16px.

导航推荐 24px，最小 16px。字标宽度至少 84px，组合至少 160px。小尺寸使用透明 PNG/ICO，不加底板、红点、阴影或圆角遮罩；16px 时细小材质细节会柔化。
...
Fleet formation vectors / 舰队编成航迹. Three staggered chevron approach vectors, broken range arcs and docking alignment ticks connect mission-based fleet formations and engineering archives. This geometry is specific to Zeppelin.
...
Use `https://h.no.mt/brands/zeppelin/v1.0.0/` for immutable material downloads. The canonical archive lives at `https://hexly.ai/projects/zeppelin#brand`. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.
...
[Exact source records](provenance.json) · [Study source](https://github.com/nocoo/hexly.ai/tree/main/artwork/logo-family/zeppelin/2026-09-19-01). Exact record paths, model/prompt/raw hashes when applicable, finishing source and source revisions are listed in provenance.json. Previous public Logo and family URLs remain valid.
