# Giraffe — Hexly campaign archive 1.0.0

A longer view of your work.
...
The official/source project identity is [official-logo.png](official-logo.png), preserved byte for byte: SHA-256 `68144efac72c45b858868fe82c6321a3f23b7428581daec62372259c72d20339`; native 2048×2048; decoded RGBA SHA-256 `774800377f2c972039f9999a476d3a784145289317203d21b840f520def78b32`. [Original source](https://github.com/nocoo/giraffe/blob/c71543478405f580e6dd36ebac18174f7ae6e474/logo.png).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `68144efac72c45b858868fe82c6321a3f23b7428581daec62372259c72d20339`; native 2048×2048; decoded RGBA SHA-256 `774800377f2c972039f9999a476d3a784145289317203d21b840f520def78b32`. It is byte-identical to the recorded project identity. Its colors and geometry are unchanged.
...
Acacia canopy relief / 金合欢树冠. Staggered acacia canopies and angled stems echo the small sprig held by the giraffe.
...
Use `https://hexly.ai/brands/giraffe/v1.0.0/` as the immutable URL root. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.
...
[Preserved family record](https://github.com/nocoo/hexly.ai/tree/d600805f7c2833d601bc32d6e3db0b02360eb0c6/artwork/logo-family/giraffe/2026-09-07-01). Exact record paths, model/prompt/raw hashes when applicable, finishing source and source revisions are listed in provenance.json. Previous public Logo and family URLs remain valid.
