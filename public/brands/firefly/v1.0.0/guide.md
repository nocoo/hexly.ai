# Firefly — Hexly campaign archive 1.0.0

A small light, a lasting story.
...
The official/source project identity is [official-logo.png](official-logo.png), preserved byte for byte: SHA-256 `a2c29a6601fb041c27c7fcc4a4493ae8b0ae09dc72d3d0da6e475400dd167759`; native 2048×2048; decoded RGBA SHA-256 `c5c4bb38f0c78b094c2c72b7f84478618fd17544c6eecf97a27ad1747c6d3df6`. [Original source](https://github.com/nocoo/firefly/blob/70a4de51b9fe6f152805298c031ca92165754c40/logo.png).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `a2c29a6601fb041c27c7fcc4a4493ae8b0ae09dc72d3d0da6e475400dd167759`; native 2048×2048; decoded RGBA SHA-256 `c5c4bb38f0c78b094c2c72b7f84478618fd17544c6eecf97a27ad1747c6d3df6`. It is byte-identical to the recorded project identity. Its colors and geometry are unchanged.
...
Midnight crescent and drifting clouds / 夜空与流云. An off-center crescent, sparse stars and broad cloud contours leave a quiet sky around the firefly.
...
Use `https://hexly.ai/brands/firefly/v1.0.0/` as the immutable URL root. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.
...
[Preserved family record](https://github.com/nocoo/hexly.ai/tree/d600805f7c2833d601bc32d6e3db0b02360eb0c6/artwork/logo-family/firefly/2026-09-06-10). Exact record paths, model/prompt/raw hashes when applicable, finishing source and source revisions are listed in provenance.json. Previous public Logo and family URLs remain valid.
