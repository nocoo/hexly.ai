# Wooly — Hexly campaign archive 1.0.0

Keep the good things in sight.
...
The official/source project identity is [official-logo.png](official-logo.png), preserved byte for byte: SHA-256 `fc1f33d2e0f84f9498291f727a8ac0e6e3b822ffe947415ae1712ed1c987d12a`; native 2048×2048; decoded RGBA SHA-256 `47800dea8a7cca3d7510610802fa0d0569fd68c77170a47832dd6f3e2e0d6861`. [Original source](https://github.com/nocoo/wooly/blob/e516e1fbcbd146fcda6b80cf071bd5367e611afd/logo.png).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `fc1f33d2e0f84f9498291f727a8ac0e6e3b822ffe947415ae1712ed1c987d12a`; native 2048×2048; decoded RGBA SHA-256 `47800dea8a7cca3d7510610802fa0d0569fd68c77170a47832dd6f3e2e0d6861`. It is byte-identical to the recorded project identity. Its colors and geometry are unchanged.
...
Wool cloud folds / 羊毛云褶. Large, uneven scallops gather into open folds, carrying the sheep’s soft curls into the margins.
...
Use `https://hexly.ai/brands/wooly/v1.0.0/` as the immutable URL root. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.
