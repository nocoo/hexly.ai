# Kite — Hexly campaign archive 1.0.0
...
The official/source project identity is [official-logo.png](official-logo.png), preserved byte for byte: SHA-256 `5e414e28dc102ee25dc7fa5ab51c1bd1ef20de1c318fdceeec5299d7a255d0d6`; native 2048×2048; decoded RGBA SHA-256 `da77b6931e5805d84dba557d68bb68dc063c124979f3384fda6e21f581034639`. [Original source](https://github.com/nocoo/kite/blob/704ae3833c9bf752ae7785d9aa6faa7756fefbbf/logo.png).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `5e414e28dc102ee25dc7fa5ab51c1bd1ef20de1c318fdceeec5299d7a255d0d6`; native 2048×2048; decoded RGBA SHA-256 `da77b6931e5805d84dba557d68bb68dc063c124979f3384fda6e21f581034639`. It is byte-identical to the recorded project identity. Its colors and geometry are unchanged.
...
Woodland-edge leaves / 林缘疏叶. Authored quiet habitat foliage, independent of the approved bird foreground.
...
Use `https://hexly.ai/brands/kite/v1.0.0/` as the immutable URL root. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.
