# Echo — Hexly campaign archive 1.0.0
...
The official/source project identity is [official-logo.png](official-logo.png), preserved byte for byte: SHA-256 `ba7421a11db8e5a5e16e3199b8d6612edd65b6ba3e98855328b2cb027644c58d`; native 2048×2048; decoded RGBA SHA-256 `bebeeb294d53708267fe2816fdfccfc76fb60ce7a13151ea00c92179ff723d3d`. [Original source](https://github.com/nocoo/echo/blob/59730aa033b97d0a9ff917b34a90bedef2a06c39/logo.png).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `ba7421a11db8e5a5e16e3199b8d6612edd65b6ba3e98855328b2cb027644c58d`; native 2048×2048; decoded RGBA SHA-256 `bebeeb294d53708267fe2816fdfccfc76fb60ce7a13151ea00c92179ff723d3d`. It is byte-identical to the recorded project identity. Its colors and geometry are unchanged.
...
Survey bearings / 勘测方位. Latitude arcs, a sparse meridian fan and short bearing marks extend the compass’s sense of direction.
...
Use `https://hexly.ai/brands/echo/v1.0.0/` as the immutable URL root. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.
...
[Preserved family record](https://github.com/nocoo/hexly.ai/tree/d600805f7c2833d601bc32d6e3db0b02360eb0c6/artwork/logo-family/echo/2026-09-07-01). Exact record paths, model/prompt/raw hashes when applicable, finishing source and source revisions are listed in provenance.json. Previous public Logo and family URLs remain valid.
