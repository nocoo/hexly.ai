# Unseal — Hexly campaign archive 1.0.0
...
The official/source project identity is [official-logo.png](official-logo.png), preserved byte for byte: SHA-256 `8868c38b03154d60f932fd26a67c198d4986476bbd81c4497bcc6f4c9e484c2b`; native 2048×2048; decoded RGBA SHA-256 `840e77e4a3e9bad9291ed7f93b06708a9d7683924ae950501ae489f60ed14b4d`. [Original source](https://github.com/nocoo/unseal/blob/61a55cdb4380bc9e5dbaada3390ef29c7be6b84a/logo.png).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `8868c38b03154d60f932fd26a67c198d4986476bbd81c4497bcc6f4c9e484c2b`; native 2048×2048; decoded RGBA SHA-256 `840e77e4a3e9bad9291ed7f93b06708a9d7683924ae950501ae489f60ed14b4d`. It is byte-identical to the recorded project identity. Its colors and geometry are unchanged.
...
Released seams / 打开的接缝. Separated perforations and folded-tab outlines suggest a seal that has just been opened.
...
Use `https://hexly.ai/brands/unseal/v1.0.0/` as the immutable URL root. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.
...
[Preserved family record](https://github.com/nocoo/hexly.ai/tree/d600805f7c2833d601bc32d6e3db0b02360eb0c6/artwork/logo-family/unseal/2026-09-07-01). Exact record paths, model/prompt/raw hashes when applicable, finishing source and source revisions are listed in provenance.json. Previous public Logo and family URLs remain valid.
