# IPSafe — Hexly campaign archive 1.0.0
...
The official/source project identity is [official-logo.png](official-logo.png), preserved byte for byte: SHA-256 `1cad3a55e3b03e27cc3962351e72026af873120e5dcd0bfb8afe9b5fe65bc75b`; native 2048×2048; decoded RGBA SHA-256 `ad40a075b02b13fde331b1fd84538c918aa442ffbd8523e8f369bfff42101283`. [Original source](https://github.com/nocoo/ipsafe/blob/d8a28afb9ed85d4f3d1627738415a863f82b3629/logo.png).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `1cad3a55e3b03e27cc3962351e72026af873120e5dcd0bfb8afe9b5fe65bc75b`; native 2048×2048; decoded RGBA SHA-256 `ad40a075b02b13fde331b1fd84538c918aa442ffbd8523e8f369bfff42101283`. It is byte-identical to the recorded project identity. Its colors and geometry are unchanged.
...
Connection lanes / 连线通道. Paired port outlines, guarded chevron lanes and short status bars describe a connection being checked.
...
Use `https://hexly.ai/brands/ipsafe/v1.0.0/` as the immutable URL root. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.
...
[Preserved family record](https://github.com/nocoo/hexly.ai/tree/d600805f7c2833d601bc32d6e3db0b02360eb0c6/artwork/logo-family/ipsafe/2026-09-07-01). Exact record paths, model/prompt/raw hashes when applicable, finishing source and source revisions are listed in provenance.json. Previous public Logo and family URLs remain valid.
