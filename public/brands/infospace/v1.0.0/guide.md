# Info Space — Hexly campaign archive 1.0.0
...
The official/source project identity is [official-logo.png](official-logo.png), preserved byte for byte: SHA-256 `3b2e9aaead0eddccf8bf2212fe96f5ed207a06dc6111f72a829dd2db0a656772`; native 2048×2048; decoded RGBA SHA-256 `86f99fbc319481ec964495407e06d4f645f2934acc9db98b31d583cdf94898f2`. [Original source](https://github.com/nocoo/infospace/blob/82f629ed42b6ec89dac0e0c79e2a63dec88ecacf/logo.png).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `3b2e9aaead0eddccf8bf2212fe96f5ed207a06dc6111f72a829dd2db0a656772`; native 2048×2048; decoded RGBA SHA-256 `86f99fbc319481ec964495407e06d4f645f2934acc9db98b31d583cdf94898f2`. It is byte-identical to the recorded project identity. Its colors and geometry are unchanged.
...
Adjustable spaces / 可调分区. Unequal panel outlines and short alignment ticks echo the tray’s adjustable dividers.
...
Use `https://hexly.ai/brands/infospace/v1.0.0/` as the immutable URL root. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.
...
[Preserved family record](https://github.com/nocoo/hexly.ai/tree/d600805f7c2833d601bc32d6e3db0b02360eb0c6/artwork/logo-family/infospace/2026-09-09-01). Exact record paths, model/prompt/raw hashes when applicable, finishing source and source revisions are listed in provenance.json. Previous public Logo and family URLs remain valid.
