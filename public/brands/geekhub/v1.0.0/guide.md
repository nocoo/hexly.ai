# GeekHub — Hexly campaign archive 1.0.0

A place to read deeply.
...
The official/source project identity is [official-logo.png](official-logo.png), preserved byte for byte: SHA-256 `7de6b36e18165d87f1a840b9f762f2dce1739f70a28b8a50a9964c1a6fa4e545`; native 2048×2048; decoded RGBA SHA-256 `43302fc2c2df45b044987581f2916f91a0606de9580a2b0aa5a3a2c9c29cd831`. [Original source](https://github.com/nocoo/geekhub/blob/d45713b5d3a0cfd1530e31a7961e1b5748f1bb6c/logo.png).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `7de6b36e18165d87f1a840b9f762f2dce1739f70a28b8a50a9964c1a6fa4e545`; native 2048×2048; decoded RGBA SHA-256 `43302fc2c2df45b044987581f2916f91a0606de9580a2b0aa5a3a2c9c29cd831`. It is byte-identical to the recorded project identity. Its colors and geometry are unchanged.
...
Collected columns / 阅读分栏. Staggered editorial columns, fine baselines and a paper-fold seam suggest a well-kept reading page.
...
Use `https://hexly.ai/brands/geekhub/v1.0.0/` as the immutable URL root. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.
...
[Preserved family record](https://github.com/nocoo/hexly.ai/tree/d600805f7c2833d601bc32d6e3db0b02360eb0c6/artwork/logo-family/geekhub/2026-09-07-01). Exact record paths, model/prompt/raw hashes when applicable, finishing source and source revisions are listed in provenance.json. Previous public Logo and family URLs remain valid.
