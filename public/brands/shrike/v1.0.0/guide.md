# Shrike — Hexly campaign archive 1.0.0

Keep your files in step.
...
The official/source project identity is [official-logo.png](official-logo.png), preserved byte for byte: SHA-256 `97692ebf5b7811eb48005f814a5688bc05d582533adab440636295370a60befa`; native 2048×2048; decoded RGBA SHA-256 `b65a3177e4fb744d1984ab05ec0d305eb5a051a84f2131ce7f5b15092d5bde06`. [Original source](https://github.com/nocoo/shrike/blob/0fec187fc22742664925897400d0c1a62b2478bb/logo.png).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `97692ebf5b7811eb48005f814a5688bc05d582533adab440636295370a60befa`; native 2048×2048; decoded RGBA SHA-256 `b65a3177e4fb744d1984ab05ec0d305eb5a051a84f2131ce7f5b15092d5bde06`. It is byte-identical to the recorded project identity. Its colors and geometry are unchanged.
...
Folded wings / 折翼层片. Broad angular pleats and short inset seams echo folded wings at opposite corners of the canvas.
...
Use `https://hexly.ai/brands/shrike/v1.0.0/` as the immutable URL root. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.
...
[Preserved family record](https://github.com/nocoo/hexly.ai/tree/d600805f7c2833d601bc32d6e3db0b02360eb0c6/artwork/logo-family/shrike/2026-09-07-01). Exact record paths, model/prompt/raw hashes when applicable, finishing source and source revisions are listed in provenance.json. Previous public Logo and family URLs remain valid.
