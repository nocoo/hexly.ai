# Showtime — Hexly campaign archive 1.0.0

Give the work its moment.

把产品最好的一刻留下。

Classic black-and-white clapperboard with SHOWTIME lettering, numbered production fields and a brushed-metal hinge.
...
The official/source project identity is [official-logo.png](official-logo.png), preserved byte for byte: SHA-256 `2e797a60a6349ee2cc62ee7c238dd41eeb7bf169af328375e090b66954400704`; native 2048×2048; decoded RGBA SHA-256 `9ea2394c883778e4a6c0ce213b6fa13d438a46b7e09aaa21583b4886aec680da`. [Original source](https://github.com/nocoo/showtime/blob/9a8c7c89ec078ba17539d76522952d3f4af3d0f7/logo.png).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `2e797a60a6349ee2cc62ee7c238dd41eeb7bf169af328375e090b66954400704`; native 2048×2048; decoded RGBA SHA-256 `9ea2394c883778e4a6c0ce213b6fa13d438a46b7e09aaa21583b4886aec680da`. It is byte-identical to the recorded project identity. Its colors and geometry are unchanged.
...
Navigation 24px preferred, 16px minimum. Wordmark ≥116px wide; lockup ≥160px. Use transparent PNG/ICO at small sizes without a tile, extra red dot, shadow or rounded mask. Fine facets soften at 16px.

导航推荐 24px，最小 16px。字标宽度至少 116px，组合至少 160px。小尺寸使用透明 PNG/ICO，不加底板、红点、阴影或圆角遮罩；16px 时细小切面会柔化。
...
Film gate and cue marks / 片门与场记. Open film-gate brackets, a narrow perforation rhythm and offset cue lines recall the work of editing.
...
Use `https://hexly.ai/brands/showtime/v1.0.0/` as the immutable URL root. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.
...
[Preserved family record](https://github.com/nocoo/hexly.ai/tree/d600805f7c2833d601bc32d6e3db0b02360eb0c6/artwork/logo-family/showtime/2026-09-10-02). Exact record paths, model/prompt/raw hashes when applicable, finishing source and source revisions are listed in provenance.json. Previous public Logo and family URLs remain valid.
