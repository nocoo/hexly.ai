# Bat — Hexly campaign archive 1.0.0

A quiet watch through the night.
...
The official/source project identity is [official-logo.png](official-logo.png), preserved byte for byte: SHA-256 `882034b5b3e7511560a999422199cb486c80ee3fc00eb586d6584326fa4f1e1d`; native 2048×2048; decoded RGBA SHA-256 `60ff960d46d5cad67e02c738b09a17498607ad59bf0088b1a9112fbb3f8ec143`. [Original source](https://github.com/nocoo/bat/blob/46f5c95a6c134487130e2a6d9336ec5e8895a0f7/logo.png).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `882034b5b3e7511560a999422199cb486c80ee3fc00eb586d6584326fa4f1e1d`; native 2048×2048; decoded RGBA SHA-256 `60ff960d46d5cad67e02c738b09a17498607ad59bf0088b1a9112fbb3f8ec143`. It is byte-identical to the recorded project identity. Its colors and geometry are unchanged.
...
Dusk scallops / 暮色翼弧. Interrupted scalloped folds echo the bat’s wings, with broad lobes and short, offset seams.
...
Use `https://hexly.ai/brands/bat/v1.0.0/` as the immutable URL root. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.
...
[Preserved family record](https://github.com/nocoo/hexly.ai/tree/d600805f7c2833d601bc32d6e3db0b02360eb0c6/artwork/logo-family/bat/2026-09-07-01). Exact record paths, model/prompt/raw hashes when applicable, finishing source and source revisions are listed in provenance.json. Previous public Logo and family URLs remain valid.
