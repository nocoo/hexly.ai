# Owl — Hexly campaign archive 1.0.0
...
The official/source project identity is [official-logo.png](official-logo.png), preserved byte for byte: SHA-256 `c0a00da0eaadabc6ca5d88210ccbcbbbcedc6cb6465f0976980c30f9e6e7e0a8`; native 2048×2048; decoded RGBA SHA-256 `366bd57afd5aad1c4bad7d31e35c22e071cf19d926d374b2212b9543aef3de64`. [Original source](https://github.com/nocoo/owl/blob/e1c69addb656e8907a8828001e1f5c103f3b9fbf/logo.png).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `c0a00da0eaadabc6ca5d88210ccbcbbbcedc6cb6465f0976980c30f9e6e7e0a8`; native 2048×2048; decoded RGBA SHA-256 `366bd57afd5aad1c4bad7d31e35c22e071cf19d926d374b2212b9543aef3de64`. It is byte-identical to the recorded project identity. Its colors and geometry are unchanged.
...
Night aperture relief / 夜间孔径. Interrupted crescents and two rectangular notches suggest an observatory aperture opening into the night.
...
Use `https://hexly.ai/brands/owl/v1.0.0/` as the immutable URL root. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.
...
[Preserved family record](https://github.com/nocoo/hexly.ai/tree/d600805f7c2833d601bc32d6e3db0b02360eb0c6/artwork/logo-family/owl/2026-09-07-01). Exact record paths, model/prompt/raw hashes when applicable, finishing source and source revisions are listed in provenance.json. Previous public Logo and family URLs remain valid.
