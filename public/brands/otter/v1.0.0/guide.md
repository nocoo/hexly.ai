# Otter — Hexly campaign archive 1.0.0

Keep your working world.
...
The official/source project identity is [official-logo.png](official-logo.png), preserved byte for byte: SHA-256 `8902636945ce93cd1a6f39a8e545d6462f0b5dd09c3d4d16d66f037d8bf10933`; native 2048×2048; decoded RGBA SHA-256 `1caf168d0eb1043f5f868d5d1d891ab4dd5e7ab09b8e0d2384ede73720e1bf49`. [Original source](https://github.com/nocoo/otter/blob/0c87197fc9b67d74f9ed6ee70c7ea8c9c4567fe3/logo.png).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `8902636945ce93cd1a6f39a8e545d6462f0b5dd09c3d4d16d66f037d8bf10933`; native 2048×2048; decoded RGBA SHA-256 `1caf168d0eb1043f5f868d5d1d891ab4dd5e7ab09b8e0d2384ede73720e1bf49`. It is byte-identical to the recorded project identity. Its colors and geometry are unchanged.
...
Riverbank sweeps / 河岸回流. Two offset eddies meet a low riverbank contour, following the otter’s relaxed curl.
...
Use `https://hexly.ai/brands/otter/v1.0.0/` as the immutable URL root. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.
...
[Preserved family record](https://github.com/nocoo/hexly.ai/tree/d600805f7c2833d601bc32d6e3db0b02360eb0c6/artwork/logo-family/otter/2026-09-07-01). Exact record paths, model/prompt/raw hashes when applicable, finishing source and source revisions are listed in provenance.json. Previous public Logo and family URLs remain valid.
