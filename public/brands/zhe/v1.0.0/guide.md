# Zhe — Hexly campaign archive 1.0.0

A shorter path to sharing.
...
The official/source project identity is [official-logo.png](official-logo.png), preserved byte for byte: SHA-256 `a0c8b924026189661b2e5eb11d876775f5a3fd506c91b32e61992f53a811a046`; native 2048×2048; decoded RGBA SHA-256 `b4a1805a9e5a92f52acf313fbc856a3a57946b8ea3e62556a1dac3e46c3ccc33`. [Original source](https://github.com/nocoo/zhe/blob/075c875936e9a244c147ff9d58452398bb1ef3cf/logo.png).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `a0c8b924026189661b2e5eb11d876775f5a3fd506c91b32e61992f53a811a046`; native 2048×2048; decoded RGBA SHA-256 `b4a1805a9e5a92f52acf313fbc856a3a57946b8ea3e62556a1dac3e46c3ccc33`. It is byte-identical to the recorded project identity. Its colors and geometry are unchanged.
...
Beeswax cells / 蜂蜡蜂房. Large, irregular honeycomb cells sit apart, tracing the quiet structure of beeswax.
...
Use `https://hexly.ai/brands/zhe/v1.0.0/` as the immutable URL root. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.
...
[Preserved family record](https://github.com/nocoo/hexly.ai/tree/d600805f7c2833d601bc32d6e3db0b02360eb0c6/artwork/logo-family/zhe/2026-09-07-01). Exact record paths, model/prompt/raw hashes when applicable, finishing source and source revisions are listed in provenance.json. Previous public Logo and family URLs remain valid.
