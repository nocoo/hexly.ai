# Deca — Hexly campaign archive 1.0.0

A familiar line to your agents.
...
The official/source project identity is [official-logo.png](official-logo.png), preserved byte for byte: SHA-256 `329bb7b41d8eac9909d35cba76f04a0e2786a702f328f2e7ccf7e8dbde478262`; native 2048×2048; decoded RGBA SHA-256 `fa9fc5a864a7eaa030c4c488d59b68c5d2e3a8703af18f0c09e0c3ad92b8c5b8`. [Original source](https://github.com/nocoo/deca/blob/1f41b41255b7184c307cb13693e94a6f45bbb9e1/logo.png).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `329bb7b41d8eac9909d35cba76f04a0e2786a702f328f2e7ccf7e8dbde478262`; native 2048×2048; decoded RGBA SHA-256 `fa9fc5a864a7eaa030c4c488d59b68c5d2e3a8703af18f0c09e0c3ad92b8c5b8`. It is byte-identical to the recorded project identity. Its colors and geometry are unchanged.
...
Switchboard paths / 交换台线路. Three rounded routing paths connect paired terminals, recalling a telephone switchboard.
...
Use `https://hexly.ai/brands/deca/v1.0.0/` as the immutable URL root. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.
...
[Preserved family record](https://github.com/nocoo/hexly.ai/tree/d600805f7c2833d601bc32d6e3db0b02360eb0c6/artwork/logo-family/deca/2026-09-07-01). Exact record paths, model/prompt/raw hashes when applicable, finishing source and source revisions are listed in provenance.json. Previous public Logo and family URLs remain valid.
