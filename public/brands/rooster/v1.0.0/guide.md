# Rooster — Hexly campaign archive 1.0.0

A clear start for every agent.
...
The official/source project identity is [official-logo.png](official-logo.png), preserved byte for byte: SHA-256 `26d77c01c7c8505d0b762f57782be514c9ce3986360a923e7e4655662085859f`; native 2048×2048; decoded RGBA SHA-256 `660afc4a9189d9f5a26813a64ef66673d8f54b6a0bf2f831e8cbebc859c5ec6e`. [Original source](https://github.com/nocoo/rooster/blob/8907933c080ed86c6cbe15d9af5cdb0be86919d3/logo.png).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `26d77c01c7c8505d0b762f57782be514c9ce3986360a923e7e4655662085859f`; native 2048×2048; decoded RGBA SHA-256 `660afc4a9189d9f5a26813a64ef66673d8f54b6a0bf2f831e8cbebc859c5ec6e`. It is byte-identical to the recorded project identity. Its colors and geometry are unchanged.
...
Dawn terraces / 晨光梯田. Unequal stepped bands and rising folds suggest terraces catching the first light of morning.
...
Use `https://hexly.ai/brands/rooster/v1.0.0/` as the immutable URL root. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.
...
[Preserved family record](https://github.com/nocoo/hexly.ai/tree/d600805f7c2833d601bc32d6e3db0b02360eb0c6/artwork/logo-family/rooster/2026-09-07-01). Exact record paths, model/prompt/raw hashes when applicable, finishing source and source revisions are listed in provenance.json. Previous public Logo and family URLs remain valid.
