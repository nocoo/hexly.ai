# Dogfight — Hexly campaign archive 1.0.0

One turn changes the sky.
...
The official/source project identity is [official-logo.png](official-logo.png), preserved byte for byte: SHA-256 `274611f248e476334769d4c4c670a1dbd0d20263fc1d210b665b2fb7b9867fc4`; native 2048×2048; decoded RGBA SHA-256 `d38c25f33fdb61ccca5e59c92e846e72b5cf06b3f66eea2008393f6fd3ac0064`. [Original source](https://github.com/nocoo/dogfight/blob/b5ab075a963a78516aaa351d6ca0178c64994729/logo.png).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `274611f248e476334769d4c4c670a1dbd0d20263fc1d210b665b2fb7b9867fc4`; native 2048×2048; decoded RGBA SHA-256 `d38c25f33fdb61ccca5e59c92e846e72b5cf06b3f66eea2008393f6fd3ac0064`. It is byte-identical to the recorded project identity. Its colors and geometry are unchanged.
...
Banking vectors / 盘旋向量. Three swept flight lanes cross short altitude ticks, following the aircraft’s banking turn.
...
Use `https://hexly.ai/brands/dogfight/v1.0.0/` as the immutable URL root. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.
...
[Preserved family record](https://github.com/nocoo/hexly.ai/tree/d600805f7c2833d601bc32d6e3db0b02360eb0c6/artwork/logo-family/dogfight/2026-09-07-01). Exact record paths, model/prompt/raw hashes when applicable, finishing source and source revisions are listed in provenance.json. Previous public Logo and family URLs remain valid.
