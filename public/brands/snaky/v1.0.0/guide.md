# Snaky — Hexly campaign archive 1.0.0

See the route before you go.

出发之前，看清流量去向。

Green snake in a natural coil with one multicolored forked tongue.
...
The official/source project identity is [official-logo.png](official-logo.png), preserved byte for byte: SHA-256 `4b2ea7f80bf081cad292c81c95e576b8ec66c6c2ece04c3d90374f971d299630`; native 2048×2048; decoded RGBA SHA-256 `828aa7fce80d2a0b999d68686ce4dda89778a8de88f29c1b06441504f5ffea46`. [Original source](https://github.com/nocoo/snaky/blob/5cd0790336d006f65555816fe29869d6e60ed376/logo.png).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `4b2ea7f80bf081cad292c81c95e576b8ec66c6c2ece04c3d90374f971d299630`; native 2048×2048; decoded RGBA SHA-256 `828aa7fce80d2a0b999d68686ce4dda89778a8de88f29c1b06441504f5ffea46`. It is byte-identical to the recorded project identity. Its colors and geometry are unchanged.
...
Meadow bends / 草地弯道. Broad S-shaped channels turn at different intervals, following a route without enclosing the snake.
...
Use `https://hexly.ai/brands/snaky/v1.0.0/` as the immutable URL root. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.
...
[Preserved family record](https://github.com/nocoo/hexly.ai/tree/d600805f7c2833d601bc32d6e3db0b02360eb0c6/artwork/logo-family/snaky/2026-09-07-01). Exact record paths, model/prompt/raw hashes when applicable, finishing source and source revisions are listed in provenance.json. Previous public Logo and family URLs remain valid.
