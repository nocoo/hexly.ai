# Basalt — Hexly campaign archive 1.0.0

A foundation for dense ideas.
...
The official/source project identity is [official-logo.png](official-logo.png), preserved byte for byte: SHA-256 `d093add49fd51eaa926db0fe260f6afa6d10c2619d141cbc35e518ad5a1cef94`; native 2048×2048; decoded RGBA SHA-256 `cf680d91bf6028626966ea6a9b22de0ad53cdb9c7c60e29f519219d3079977f5`. [Original source](https://github.com/nocoo/basalt/blob/9e226aa5c1376351ec76a659b1a33a8139892b4b/logo.png).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `97144a6615113b5981454492776755d486183c219e5f1d8155f17572d21564e7`; native 2048×2048; decoded RGBA SHA-256 `0a041e450710e8788f5c7e4031e5c78c55c888ba7b03ced0f972bfb2621094df`. It differs from the recorded project identity and remains a Hexly campaign interpretation. The existing family status is review; this release does not claim source adoption. Its colors and geometry are unchanged.
...
Corner tower construction grid / 角楼建造网格. Datum lines, roof-elevation strokes and dimension ticks recall the precision behind the corner tower.
...
Use `https://hexly.ai/brands/basalt/v1.0.0/` as the immutable URL root. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.
...
[Preserved family record](https://github.com/nocoo/hexly.ai/tree/d600805f7c2833d601bc32d6e3db0b02360eb0c6/artwork/logo-family/basalt/2026-09-08-01). Exact record paths, model/prompt/raw hashes when applicable, finishing source and source revisions are listed in provenance.json. Previous public Logo and family URLs remain valid.
