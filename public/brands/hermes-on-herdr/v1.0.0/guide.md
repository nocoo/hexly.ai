# hermes on herdr — Hexly campaign archive 1.0.0

An open door to your agents.
...
The official/source project identity is [official-logo.png](official-logo.png), preserved byte for byte: SHA-256 `ba0a4a0a403d4775ce917290dc528884b0ac6666068ed0148f655777f815d719`; native 2048×2048; decoded RGBA SHA-256 `800ee7781835fe6fd6f6cbff3bd4d5fa038a0305cdc1f7b0aaa66a0b4b82f96e`. [Original source](https://github.com/nocoo/hermes-on-herdr/blob/f14ddf11bf4ac4912830f0a7259fdd8a769e5a41/logo.png).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `ba0a4a0a403d4775ce917290dc528884b0ac6666068ed0148f655777f815d719`; native 2048×2048; decoded RGBA SHA-256 `800ee7781835fe6fd6f6cbff3bd4d5fa038a0305cdc1f7b0aaa66a0b4b82f96e`. It is byte-identical to the recorded project identity. Its colors and geometry are unchanged.
...
Paired panes and a returning route / 双窗与回返路线. Two unequal pane outlines and a returning route echo the open gateway and its terminal inlay.
...
Use `https://hexly.ai/brands/hermes-on-herdr/v1.0.0/` as the immutable URL root. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.
...
[Preserved family record](https://github.com/nocoo/hexly.ai/tree/d600805f7c2833d601bc32d6e3db0b02360eb0c6/artwork/logo-family/hermes-gateway-herdr/2026-09-11-01). Exact record paths, model/prompt/raw hashes when applicable, finishing source and source revisions are listed in provenance.json. Previous public Logo and family URLs remain valid.
