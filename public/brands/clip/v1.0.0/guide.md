# clip — Hexly campaign archive 1.0.0

From a schema to a command.
...
The official/source project identity is [official-logo.png](official-logo.png), preserved byte for byte: SHA-256 `4892842297da37ebe701ad3c9d9713164b32879f1c8a93faf357e3feb5bd5009`; native 2048×2048; decoded RGBA SHA-256 `963e9e0e52d168d56139a609fa918166741f14a9d80acddfe399f9f3dae334d6`. [Original source](https://github.com/nocoo/clip/blob/d5dcc44d769d5f5ebc08d47537684a9d34cb6a6c/logo.png).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `3399eb7f9ed54899845c6d686ad3c498c253b369e61b8acee4e41fd161158983`; native 2048×2048; decoded RGBA SHA-256 `4ff5d89c58a21bd394df8828109efa163c255754d0005051cbe966c074dadb36`. It differs from the recorded project identity and remains a Hexly campaign interpretation. The existing family status is review; this release does not claim source adoption. Its colors and geometry are unchanged.
...
Windward feather relief / 迎风羽纹. Long curved quills and gently splayed barbs carry the hat feather’s windward motion into the paper.
...
Use `https://hexly.ai/brands/clip/v1.0.0/` as the immutable URL root. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.
