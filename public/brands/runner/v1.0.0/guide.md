# Runner — Hexly campaign archive 1.0.0

Good timing, every time.
...
The official/source project identity is [official-logo.png](official-logo.png), preserved byte for byte: SHA-256 `8a388497c330de53d8848238cad6d2e5e3c5647c6da6658e4b7a7c9468213347`; native 2048×2048; decoded RGBA SHA-256 `0d3ab5fc8ad2ea98f660678674a71234de727223b65cf221bb6bb99ee581ad9e`. [Original source](https://github.com/nocoo/runner/blob/a5d786175358dee245773bd98af83eef4bbf5689/logo.png).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `8a388497c330de53d8848238cad6d2e5e3c5647c6da6658e4b7a7c9468213347`; native 2048×2048; decoded RGBA SHA-256 `0d3ab5fc8ad2ea98f660678674a71234de727223b65cf221bb6bb99ee581ad9e`. It is byte-identical to the recorded project identity. Its colors and geometry are unchanged.
...
Scheduled minutes / 排程刻度. An interrupted minute track, an offset timing arc and grouped launch ticks make time visible.
...
Use `https://hexly.ai/brands/runner/v1.0.0/` as the immutable URL root. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.
...
[Preserved family record](https://github.com/nocoo/hexly.ai/tree/d600805f7c2833d601bc32d6e3db0b02360eb0c6/artwork/logo-family/runner/2026-09-07-01). Exact record paths, model/prompt/raw hashes when applicable, finishing source and source revisions are listed in provenance.json. Previous public Logo and family URLs remain valid.
