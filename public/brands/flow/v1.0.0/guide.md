# Flow — Hexly campaign archive 1.0.0
...
The official/source project identity is [official-logo.png](official-logo.png), preserved byte for byte: SHA-256 `d08f2ee2cb2c322b54dbd9677180e210756c2cc8094784c6fb86e435d43afe23`; native 2048×2048; decoded RGBA SHA-256 `f82a6e06d0392fa88169a35baf45f734ba12a43f8e60d75d191dabdbd9b83ffb`. [Original source](https://github.com/nocoo/flow/blob/f4a9e9464d64184b793240adff182e08c04997e1/logo.png).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `d08f2ee2cb2c322b54dbd9677180e210756c2cc8094784c6fb86e435d43afe23`; native 2048×2048; decoded RGBA SHA-256 `f82a6e06d0392fa88169a35baf45f734ba12a43f8e60d75d191dabdbd9b83ffb`. It is byte-identical to the recorded project identity. Its colors and geometry are unchanged.
...
Pinyin key rhythm / 拼音键律. Staggered key outlines meet rising and falling tone strokes, linking a keyboard to the cadence of pinyin.
...
Use `https://hexly.ai/brands/flow/v1.0.0/` as the immutable URL root. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.
...
[Preserved family record](https://github.com/nocoo/hexly.ai/tree/d600805f7c2833d601bc32d6e3db0b02360eb0c6/artwork/logo-family/flow/2026-09-07-01). Exact record paths, model/prompt/raw hashes when applicable, finishing source and source revisions are listed in provenance.json. Previous public Logo and family URLs remain valid.
