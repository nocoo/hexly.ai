# Bogo — Hexly campaign archive 1.0.0
...
The official/source project identity is [official-logo.png](official-logo.png), preserved byte for byte: SHA-256 `54bff5a21a25489a94b5ad3d816332dc7082ed4a41510d782a3c33a05a17fac1`; native 2048×2048; decoded RGBA SHA-256 `0e65a5f9f626a218390f9e483657a774beb85b81abbdc43e751958194c12f384`. [Original source](https://github.com/nocoo/bogo/blob/77e211a294a885fff2830d0aba2e48a10299dff1/logo.png).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `54bff5a21a25489a94b5ad3d816332dc7082ed4a41510d782a3c33a05a17fac1`; native 2048×2048; decoded RGBA SHA-256 `0e65a5f9f626a218390f9e483657a774beb85b81abbdc43e751958194c12f384`. It is byte-identical to the recorded project identity. Its colors and geometry are unchanged.
...
Mineral horn arches / 矿石角拱. Broken polygonal arches recall the buffalo’s horns; their open ends leave the face and flower sprig in focus.
...
Use `https://hexly.ai/brands/bogo/v1.0.0/` as the immutable URL root. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.
...
[Preserved family record](https://github.com/nocoo/hexly.ai/tree/d600805f7c2833d601bc32d6e3db0b02360eb0c6/artwork/logo-family/bogo/2026-09-07-05). Exact record paths, model/prompt/raw hashes when applicable, finishing source and source revisions are listed in provenance.json. Previous public Logo and family URLs remain valid.
