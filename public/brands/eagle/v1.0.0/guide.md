# Eagle — Hexly campaign archive 1.0.0
...
Hexly palettes, typography, red points and editorial geometry apply only to the hexly.ai archive and Hexly-authored promotional materials, video, Deck and social graphics. Independent product websites keep their own full palettes, themes and visual identity. Source Logo adoption is recorded at d03eb4d276ec20ead665e490eb78ce5b09d720a5. Brand version 1.0.0 is independent of the product package version; kit assembly changes no runtime or product UI.

The official/source project identity is [official-logo.png](official-logo.png), preserved byte for byte: SHA-256 `2dbda2e185133a9f708cbad1190c817d18ff5bb96aa1337f0a18edc9b5532e20`; native 2048×2048; decoded RGBA SHA-256 `023bef3908fbec406ef98ce6181c714ff5f8ff2b5e090618e90d00fc05f08f54`. [Original source](https://github.com/nocoo/eagle/blob/d03eb4d276ec20ead665e490eb78ce5b09d720a5/logo.png).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `2dbda2e185133a9f708cbad1190c817d18ff5bb96aa1337f0a18edc9b5532e20`; native 2048×2048; decoded RGBA SHA-256 `023bef3908fbec406ef98ce6181c714ff5f8ff2b5e090618e90d00fc05f08f54`. It is byte-identical to the recorded project identity. Its colors and geometry are unchanged.
...
Mountain pine and alpine leaves / 山松针叶与高山叶片. Open mountain-pine needles and sparse alpine leaves evoke a golden eagle above mountain woodland. The habitat surface is independent of product features and other project motifs.
...
Use `https://h.no.mt/brands/eagle/v1.0.0/` for immutable material downloads. The canonical archive lives at `https://hexly.ai/projects/eagle#brand`. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.
...
[Exact source records](provenance.json) · [Study source](artwork/logo-family/eagle/2026-09-19-01). Exact record paths, model/prompt/raw hashes when applicable, finishing source and source revisions are listed in provenance.json. Previous public Logo and family URLs remain valid.
