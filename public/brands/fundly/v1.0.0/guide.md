# Fundly — Hexly campaign archive 1.0.0
...
The official/source project identity is [official-logo.svg](official-logo.svg), preserved byte for byte: SHA-256 `08ec45808b94078caa2a31720da96adf9b9aadfdaf5498c98cfc0c2adc973bf8`; native 32×32; decoded RGBA SHA-256 `d860d3631ca41b7e24a7e25c883c964e40c2381531b2f9c0e3e17d610b63d7e8`. [Original source](https://github.com/nocoo/fundly/blob/6de762074e00011009f7604bbeeb7c0b04923c00/apps/web/public/logo.svg).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `e45f5a9e9c062160d2ad91785f7ce9e9ddfb27b41362cfd89a539429b9fceb7f`; native 2048×2048; decoded RGBA SHA-256 `d65c30e99247f3cdf1c19569f5f08fdb15f1fc54ac98d2bb249a89c899e703b7`. It differs from the recorded project identity and remains a Hexly campaign interpretation. The existing family status is review; this release does not claim source adoption. Its colors and geometry are unchanged.
...
Far-horizon sightlines / 远眺视线. Broad horizon bands open toward the penguin’s gaze, with restrained sighting ticks in the distance.
...
Use `https://hexly.ai/brands/fundly/v1.0.0/` as the immutable URL root. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.

- Official product identity: `official-logo.svg`.
...
[Preserved family record](https://github.com/nocoo/hexly.ai/tree/d600805f7c2833d601bc32d6e3db0b02360eb0c6/artwork/logo-family/fundly/2026-09-07-01). Exact record paths, model/prompt/raw hashes when applicable, finishing source and source revisions are listed in provenance.json. Previous public Logo and family URLs remain valid.
