# Pika — Hexly campaign archive 1.0.0
...
The official/source project identity is [official-logo.png](official-logo.png), preserved byte for byte: SHA-256 `2dc5121317e88001e8459d007419d5b9ca998a95f91bee4992b70bba96aacd2b`; native 2048×2048; decoded RGBA SHA-256 `eb0b6d340814453446719fdb25a356e8409980a029ab89d445b50a866d10bca3`. [Original source](https://github.com/nocoo/pika/blob/bb9b497372809e5ca00eaef4b04e1aa51e4256a3/logo.png).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `2dc5121317e88001e8459d007419d5b9ca998a95f91bee4992b70bba96aacd2b`; native 2048×2048; decoded RGBA SHA-256 `eb0b6d340814453446719fdb25a356e8409980a029ab89d445b50a866d10bca3`. It is byte-identical to the recorded project identity. Its colors and geometry are unchanged.
...
Charge steps / 闪电阶梯. Broad angular charge paths and interrupted zigzags follow the energy of the original lightning gesture.
...
Use `https://hexly.ai/brands/pika/v1.0.0/` as the immutable URL root. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.
...
[Preserved family record](https://github.com/nocoo/hexly.ai/tree/d600805f7c2833d601bc32d6e3db0b02360eb0c6/artwork/logo-family/pika/2026-09-07-01). Exact record paths, model/prompt/raw hashes when applicable, finishing source and source revisions are listed in provenance.json. Previous public Logo and family URLs remain valid.
