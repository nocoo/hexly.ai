# Backy — Hexly campaign archive 1.0.0
...
The official/source project identity is [official-logo.png](official-logo.png), preserved byte for byte: SHA-256 `a89f2303bd3f791f240b514665325c8be7bce60f6a2338bc3efcad2248a6c7ef`; native 2048×2048; decoded RGBA SHA-256 `49f884dafacfb6da547e5c951c5ee9fe475828902dcb703aa26461125e2238bd`. [Original source](https://github.com/nocoo/backy/blob/5b23349c94ac6778f2242a857386e8b01dac4f1c/logo.png).

The Hexly family artwork is [logo.png](logo.png): SHA-256 `a89f2303bd3f791f240b514665325c8be7bce60f6a2338bc3efcad2248a6c7ef`; native 2048×2048; decoded RGBA SHA-256 `49f884dafacfb6da547e5c951c5ee9fe475828902dcb703aa26461125e2238bd`. It is byte-identical to the recorded project identity. Its colors and geometry are unchanged.
...
Shell saddles / 龟壳叠弧. Unequal shell plates and interrupted seams form a sheltered rhythm around the small tortoise.
...
Use `https://hexly.ai/brands/backy/v1.0.0/` as the immutable URL root. Download only the needed roles from manifest.json and verify each file's bytes/SHA before adoption.
...
[Preserved family record](https://github.com/nocoo/hexly.ai/tree/d600805f7c2833d601bc32d6e3db0b02360eb0c6/artwork/logo-family/backy/2026-09-07-01). Exact record paths, model/prompt/raw hashes when applicable, finishing source and source revisions are listed in provenance.json. Previous public Logo and family URLs remain valid.
