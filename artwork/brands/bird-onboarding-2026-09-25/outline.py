...
uv run --with fonttools==4.60.1 --with brotli==1.1.0 python artwork/brands/bird-onboarding-2026-09-25/outline.py
...
scale = 140 / units
tracking = -units / 23
inventory = json.loads(Path("artwork/brands/bird-onboarding-2026-09-25/identity-inventory.json").read_text())
...
print("Outlined and measured the selected names and motif geometries with the real site font.")
