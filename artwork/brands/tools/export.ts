...
// bun artwork/brands/tools/export.ts <project-id> <brand-version>
...
if (
	...
	throw new Error(
		"Usage: bun artwork/brands/tools/export.ts <project-id> <brand-version>",
	);
...
for (const project of projects) {
	...
	const provenance = {
		...
		build: {
			...
			tool: `${toolRoot}/export.ts`,
			toolSha256: hash(await readFile(`${toolRoot}/export.ts`)),
