...
Delivery includes all transparent/square/rounded PNGs at 2048, 1024, 512, 256, 128, 64, 48, 32, 24, and 16 px, the pure-white master, complete layers, [static review](review.html), and [catalogue review](https://index.dev.hexly.ai/logos/firefly). Source adoption and production verification are recorded separately when completed. Historical images and Pew finishing 04 are preserved.
