...
enum Theme {
    static let ink = Color(red: 0.13, green: 0.14, blue: 0.2)
    static let muted = Color(red: 0.52, green: 0.53, blue: 0.59)
    static let accent = Color(red: 0.48, green: 0.36, blue: 0.87)
    static let line = Color.black.opacity(0.065)
    static let surface = Color(red: 0.968, green: 0.971, blue: 0.979)
}
    ...
    private var header: some View {
        HStack(spacing: 11) {
            ZStack {
                ...
                Image(systemName: "play.rectangle.fill").font(.system(size: 18, weight: .medium)).foregroundStyle(Color(red: 0.82, green: 0.77, blue: 1))
            }
