...
cp "$SHOWTIME_ROOT/scripts/showtime" "$SHOWTIME_ROOT/scripts/showtime_cli.py" "$SHOWTIME_ROOT/scripts/showtime_client.py" "$SHOWTIME_ROOT/scripts/showtime_mcp.py" "$SHOWTIME_APP/Contents/Resources/Tools/"
